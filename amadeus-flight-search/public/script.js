  ...
  results.forEach(({ itineraries, price }) => {
    ...
    searchResults.insertAdjacentHTML(
      ...
      `<li class="flex-column flex-sm-row list-group-item d-flex justify-content-between align-items-sm-center">
        ...
        <span class="bg-sucess rounded-pill m-2 badge fs-6"><a href="http://localhost/projects/hackathon/amadeus/esgpoints/app/src/client/get-points.php?points=${priceLabel}">COMPRAR<a></span>
      </li>`
    );
  });
};
